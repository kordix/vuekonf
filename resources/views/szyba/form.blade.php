<div class="form-group {{ $errors->has('artnr') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="artnr" type="text" id="artnr" value="{{ isset($szyba->artnr) ? $szyba->artnr : ''}}" >
...
<div class="form-group {{ $errors->has('bez') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bez" type="text" id="bez" value="{{ isset($szyba->bez) ? $szyba->bez : ''}}" >
