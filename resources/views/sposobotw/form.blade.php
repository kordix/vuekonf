<div class="form-group {{ $errors->has('artnr') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="artnr" type="text" id="artnr" value="{{ isset($sposobotw->artnr) ? $sposobotw->artnr : ''}}" >
...
<div class="form-group {{ $errors->has('bez') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bez" type="text" id="bez" value="{{ isset($sposobotw->bez) ? $sposobotw->bez : ''}}" >
